...
#-------------------------------------------------------------------------------
def get_root_project_src_dir(fips_dir) :
    """get parent of parent of fips dir
    
    :param fips_dir:    absolute path to fips
    :returns:           absolute path to root src project dir (svn root/Src)
    """
    third_dir = os.path.split(fips_dir)[0]
    src_dir = os.path.split(third_dir)[0]
    return src_dir
    
#-------------------------------------------------------------------------------
def get_root_project_dir(fips_dir) :
    """get parent of parent of parent of fips dir
    
    :param fips_dir:    absolute path to fips
    :returns:           absolute path to root project dir (svn root)
    """
    src_dir = get_root_project_src_dir(fips_dir)
...
def get_project_dir(fips_dir, proj_name) :
    ...
    """
    if proj_name == 'Src' :
        return get_root_project_src_dir(fips_dir)
    else:
...
def get_build_dir(fips_dir, proj_name, cfg) :
    ...
    """
    root_dir = get_root_project_dir(fips_dir)
    return '{}/Build/{}/{}'.format(root_dir, proj_name, cfg['name'])
...
def get_deploy_dir(fips_dir, proj_name, cfg) :
    ...
    """
    root_dir = get_root_project_dir(fips_dir)
    return '{}/Deploy/{}/{}'.format(root_dir, proj_name, cfg['name'])
