...
deploy_path = util.get_deploy_dir(proj_path + "/Third/fips", "Src", {'name': items['config']})
...
def get_shaderc_path() :
    ...
    print "####shaderC path: %s" % (shaderc_path)
...
def get_include_path() :
    ...
    include_path = '{}/Third/bgfx/src'.format(proj_path)
