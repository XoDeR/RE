...
namespace Rio
{
	...
	namespace Color4Fn
	{
		...
		inline uint32_t toBgr(const Color4& c)
		{
			uint32_t abgr;
		...
		inline uint32_t toRgba(const Color4& c)
		{
			uint32_t rgba;
		...
		inline uint32_t toAbgr(const Color4& c)
		{
			uint32_t abgr;
		...
		inline float* toFloatPtr(Color4& c)
		{
			return &c.r;
		}

		inline const float* toFloatPtr(const Color4& c)
		{
			return &c.r;
		}
	} // namespace Color4Fn
